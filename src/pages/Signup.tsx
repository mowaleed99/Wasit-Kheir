  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-purple-600">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-600 to-pink-700 opacity-90 mix-blend-multiply"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center h-full p-16 text-white w-full max-w-2xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-xl text-purple-100/90 leading-relaxed max-w-lg">
              {t('auth.footerText')}
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24 py-12 relative">
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">{t('auth.joinCommunity')}</p>
          </div>
