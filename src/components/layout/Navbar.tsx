      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6 flex-1 max-w-2xl">
          ...
          <Link to="/search" className="relative flex-1 max-w-md hidden md:block">
            ...
            <div
              className="w-full pl-10 pr-4 py-2 bg-muted/50 border border-border rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-background transition-all text-sm text-muted-foreground cursor-pointer hover:bg-muted"
            >
              {t("search")}
            </div>
          </Link>
