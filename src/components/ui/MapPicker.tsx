...
export const MapPicker: React.FC<MapPickerProps> = ({
  ...
  return (
    <div className="relative w-full h-96 rounded-lg overflow-hidden border border-gray-300">
      ...
      {/* Instructions */}
      <div 
        className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-lg shadow-md"
        style={{ zIndex: 1000 }}
      >
      ...
      <button
        ...
        className="absolute top-4 right-16 bg-white px-3 py-1.5 rounded-lg shadow-md hover:bg-gray-50 transition-colors flex items-center gap-2 border border-gray-200"
        style={{ zIndex: 1000 }}
